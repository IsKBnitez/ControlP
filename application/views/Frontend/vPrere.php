        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Gestion de Pre-Requisitos</h3>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="home">
                          ...
                          <div class="col-lg-6">
                            <form class="" action="<?php echo base_url();?>cPrere/guardar" method="post">
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form id="frmmodificar" class="" action="<?php echo base_url();?>cPrere/modificar" method="post">
                                            <table class="table-responsive">
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  <label>Codigo</label>
                                                  <input class="form-control" id="codigo2" readonly="readonly" placeholder="Codigo" name="codigo2">
                                              </div>
                                              <div class="form-group">
                                                  <label>Nombre</label>
