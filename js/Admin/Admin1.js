        ...
        $.ajax({
          ...
          success:function(respuesta) {
            ...
            for (var i = 0; i < registros.length; i++) {
              foto[registros[i]["id_usuario"]]=registros[i]["foto"];
              html+="<tr><td></td><td>"+registros[i]["id_usuario"]+"</td><td>"+registros[i]["nombre"]+"</td><td>"+registros[i]["apellido"]+"</td><td><img id='imgtb' src='http://localhost:80/ControlP/img/docente/"+registros[i]["foto"]+"'/></td><td>"+registros[i]["sexo"]+"</td><td>"+registros[i]["edad"]+"</td>";
              html+="<td>"+registros[i]["numero_tel"]+"</td><td>"+registros[i]["email_usua"]+"</td><td>"+registros[i]["usuario"]+"</td><td><a href='"+registros[i]["id_usuario"]+"' class='btn btn-warning' data-toggle='modal' data-target='.bs-example-modal-lg'>E</a>  <button class='btn btn-danger' value='"+registros[i]["id_usuario"]+"'>X</button></td></tr>";
            };
            html +="</tbody></table>";
            $("#tabla").html(html);
          }
